...
distance= [1]; % This is the distance that the third vertex of the triangle
...
%%
% Y_var= linspace(2, 4, data_count);
% X_var= linspace(230, 238, data_count);
% x_o_0= [0 235 3 0 0 0]';
% count=0;
% alpha= 10000;
% apf_obst_fin=0;
...
for i= 1:1:width(x_o_0)
    if x_o_0(6,i)>0
        flag(i)= region1(si_form(:,i), x_h_0);
    elseif x_o_0(6,i)==0
        flag(i)= region2(si_form(:,i), x_h_0, v_alp1{:,i});
    elseif x_o_0(6,i)<0
        flag(i)= region3(si_form(:,i), x_h_0);
    end
end
count1=0;
count2=0;
    ...
    for k=1:length(X_var)
        ...
        for i= 1:1:width(x_o_0)
            if x_o_0(6,i)>0
                ...
                if flag1(i)==flag(i)
                    count1= count1+1;
                    X_vartempin(i,count1)= x_h(2,1);
                    Y_vartempin(i,count1)= x_h(3,1);
                else
                    count2= count2+1;
                    X_vartempout(i,count2)= x_h(2,1);
                    Y_vartempout(i,count2)= x_h(3,1);
                end
            elseif x_o_0(6,i)==0
...
tic
Y_var= linspace(0, 6, data_count);
X_var= linspace(v1(1,1)+0.01,245, data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
...
surfplot_rect(x_h_0, x_o_0, distance, size_veh, select1, 0);
contour(X_var,Y_var,apf_obst1,100);
hold off;
shading interp;
xlabel('Longitudinal Distance')
ylabel('Lateral Distance')
...
hold off;
Y_var= linspace(0, 6, data_count);
X_var= linspace(v1(2,1)+0.01,245, data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (y-m(2,1)*x-b(2,1))>0 && (x-v1(1,1))>=0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
hold off;
Y_var= linspace(0, 6, data_count);
X_var= linspace(v1(3,1)+0.01,v1(2,1)-0.01, data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (x-v1(1,1))<0 && (x-v1(3,1))>=0 && (y-m(2,1)*x-b(2,1))>0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
hold off;
Y_var= linspace(0, 6, data_count);
X_var= linspace(v1(4,1)+0.01,v1(3,1)-0.01, data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (x-v1(3,1))<0 && (y-m(7,1)*x-b(7,1))>=0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
hold off;
Y_var= linspace(0, 6, data_count);
X_var= linspace(225,v1(3,1)-0.01, data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (y-m(8,1)*x-b(8,1))>=0 && (y-m(7,1)*x-b(7,1))<0 && (y-m(3,1)*x-b(3,1))>0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
hold off;
Y_var= linspace(0, 6, data_count);
X_var= linspace(225, v1(4,1), data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (y-m(8,1)*x-b(8,1))<0 && (y-m(9,1)*x-b(9,1))>=0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
hold off;
Y_var= linspace(0, 6, data_count);
X_var= linspace(225,v1(5,1)-0.01, data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (y-m(9,1)*x-b(9,1))<0 && (y-m(10,1)*x-b(10,1))>=0 && (y-m(4,1)*x-b(4,1))<0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
for j= 1:length(Y_var)
    for k=1:length(X_var)
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (y-m(10,1)*x-b(10,1))<0 && (x-v1(3,1))<=0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
hold off;
Y_var= linspace(0, 6, data_count);
X_var= linspace(v1(5,1)+0.01,v1(1,1)-0.01,data_count);
for j= 1:length(Y_var)
    for k=1:length(X_var)
        x_h(2,1)= X_var(k);
        x_h(3,1)= Y_var(j);
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (x-v1(1,1))<=0 && (x-v1(3,1))>0 && (y-m(5,1)*x-b(5,1))<0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
for j= 1:length(Y_var)
    for k=1:length(X_var)
        ...
        y= x_h(3,1);
        x= x_h(2,1);
        if (x-v1(1,1))>0 && (y-m(5,1)*x-b(5,1))<=0
            apf_obst1(j,k)= sum(u);
        else
           apf_obst1(j,k)= 0; 
        end
...
%                     p= [xx yy];
%                     K = sqrt((x-xx)^2+ (y-yy)^2);
%                     [u, ux, uy, uxx, uyy, uyx, uxy]= derv2(p1, p, const);
%                 elseif m~=0
%                     b= y0-m*x0;
%                     xx= ((x+m*y-m*b)/(m^2+1));
%                     yy= ((m*(m*y+x)+b)/(m^2+1));
%                     K = sqrt((x-xx)^2+ (y-yy)^2);
%                     [u, ux, uy, uxx, uyy, uyx, uxy]= derv3(p, const, m, b);
%                 end
%             elseif isinf(m)==1
%                 xx= x0;
%                 yy= y;
...
[si_form]= equations(v_alp1, v_alp2, x_o_0);
    for i=1:1:length(v_alp1)
        ...
        elseif x_o_0(6,i)==0
            plot3([vertices1(2,1) vertices1(2,1)], [vertices2(2,1) vertices2(2,1)+1], [alpha alpha], 'Color', 'r','DisplayName', 'L1'); %L1
            plot3([vertices1(1,1) vertices1(1,1)], [vertices2(1,1) vertices2(1,1)-1], [alpha alpha], 'Color', 'r','DisplayName', 'L1'); %L1
            ...
            plot3([vertices1(3,1) vertices1(3,1)], [vertices2(3,1) vertices2(3,1)+1], [alpha alpha], 'Color', 'r','DisplayName', 'L6'); %L6
            plot3([vertices1(5,1) vertices1(5,1)], [vertices2(5,1) vertices2(5,1)-1], [alpha alpha], 'Color', 'r','DisplayName', 'L6'); %L6
